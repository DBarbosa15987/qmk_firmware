...
//    ├─────────────┼──────┼───┼──────┼─────┼──────┼───┘       ├──────────┼─────┼──────┼───┼───┼───┼──────┬─────┤     ├───────┤
//    │     tab     │  q   │ w │  e   │  r  │  t   │           │    y     │  u  │  i   │ o │ p │ + │  ´   │  ~  │     │  f20  │
//    ├─────────────┼──────┼───┼──────┼─────┼──────┤           ├──────────┼─────┼──────┼───┼───┼───┼──────┴─────┤     ├───────┤
//    │ LT(3, caps) │  a   │ s │  d   │  f  │  g   │           │    h     │  j  │  k   │ l │ ç │ º │            │     │  f21  │
//    ├─────────────┼──────┼───┼──────┼─────┼──────┤           ├──────────┼─────┼──────┼───┼───┼───┼──────┬─────┤     └───────┘
//    │    lsft     │  z   │ x │  c   │  v  │  b   │           │   bspc   │  n  │  m   │ , │ . │ - │ rsft │     │
//    ├─────────────┼──────┼───┼──────┼─────┼──────┤           ├──────────┼─────┼──────┼───┴───┴───┼──────┼─────┼─────┐
//    │    lctl     │ lgui │   │ lalt │ ent │ del  │           │ MO(_FN2) │ spc │ ralt │           │      │     │     │
//    └─────────────┴──────┘   └──────┴─────┴──────┘           └──────────┴─────┴──────┘           └──────┴─────┴─────┘
[WIN_BASE] = LAYOUT_ansi_69(
  KC_ESC         , KC_1    , KC_2 , KC_3    , KC_4   , KC_5    , KC_6 ,         KC_7     , KC_8   , KC_9    , KC_0    , KC_MINS , KC_EQL  ,      XXXXXXX      ,           KC_MUTE,
  KC_TAB         , KC_Q    , KC_W , KC_E    , KC_R   , KC_T    ,                KC_Y     , KC_U   , KC_I    , KC_O    , KC_P    , KC_LBRC , KC_RBRC , KC_BSLS ,           KC_F20 ,
  LT(5, KC_CAPS) , KC_A    , KC_S , KC_D    , KC_F   , KC_G    ,                KC_H     , KC_J   , KC_K    , KC_L    , KC_SCLN , KC_QUOT ,      MO(3)        ,           KC_F21 ,
  KC_LSFT        , KC_Z    , KC_X , KC_C    , KC_V   , KC_B    ,                KC_BSPC  , KC_N   , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , KC_RSFT , XXXXXXX                    ,
  KC_LCTL        , KC_LWIN ,        KC_LALT , KC_ENT , KC_DEL  ,                MO(_FN2) , KC_SPC , KC_RALT ,                               XXXXXXX , XXXXXXX , XXXXXXX
),
...
[_FN2] = LAYOUT_ansi_69(
  ...
  _______ , _______ ,           _______ , _______ , MY_COPY ,                 _______ , _______ , _______ ,                               _______ , _______ , _______
),
